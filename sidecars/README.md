...
This directory contains the Archivist node binaries for each platform.
...
Place the binaries in this directory with the exact filenames above.

## Note

These binaries are gitignored due to their size. Each developer/CI pipeline must download them separately.
